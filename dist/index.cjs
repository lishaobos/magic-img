...
const lqip$1 = require('lqip');
const sqip$1 = require('sqip');
...
const jimp__namespace = /*#__PURE__*/_interopNamespaceDefault(jimp);
...
async function cucoloris(filePath, params) {
  const data = await jimp__namespace.read(filePath);
